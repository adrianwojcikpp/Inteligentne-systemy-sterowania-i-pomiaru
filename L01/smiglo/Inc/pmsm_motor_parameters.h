...
#define LS                     0.000270 /* Stator inductance, H
...
#define NOMINAL_CURRENT         4984
#define MOTOR_MAX_SPEED_RPM     6100 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  0.1 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -4984 /*!< Demagnetization current */
